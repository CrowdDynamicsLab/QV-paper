...
\acmConference[CSCW '21]{CSCW '21: The 24rd ACM Conference on Computer-Supported Cooperative Work and Social Computing}{Oct 17 -- 21, 2020}{Virtual}
...
\title[Comparing Quadratic Voting with Likert Surveys]{Comparing Quadratic Voting with Likert Surveys: A Better Mechanism for Decision Making}
...
%% article.
\begin{abstract}
  Surveys are useful at aggregating individuals' attitudes among crowds to form consensus when there are constraints in resource distribution. This study compares how results from Quadratic Voting (QV) and Likert Surveys align with participants' true preferences. Both experiments, one on societal causes and another on HCI study, showed QV aligned significantly better to people's true preferences. The experiments also showed that voice credits in QV matter to its performances.
\end{abstract}
