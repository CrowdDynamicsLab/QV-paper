...
\tc{
In addition, we asked participants to complete two of the three QV surveys to help understand how an increase or decrease in voice credits impacted their response behavior. In order to minimize the learning effects between the two versions, we provided them with a playground to get familiar with the QV interface and mechanism before taking the surveys, and we randomized the order of the two versions.
}


\textbf{Step 3: Filler Task} After both groups of participants completed their surveys on the nine societal causes, \lwt{as a filler task,} they answered a free-form text question about their thoughts on another set of societal issues unrelated to those presented in the previous stage, such as increasing funding for Medicaid, strengthening gun control, and tighten social media regulation. For a complete list of causes, please refer to the supplementary material. \tc{Using a filler task in an experiment is a common practice in psychology \cite{jamieson2011intervening} and HCI experiments \cite{gould2015home, experiment2015} to prevent participants to infer the experiment's purpose and form strategies when completing successive tasks.} We designed this survey to prevent participants from directly connecting their survey responses with the upcoming donation tasks.
...
\lwt{We believe a binding out-of-pocket voluntary donation was a suitable task to estimate the participants' true preferences for two reasons. First, many prior work frequently estimated true preferences with voluntary donations with actual binding financial consequences in either a lab or field setting \cite{zawojska2015re, getzner2000hypothetical, ready2010using, benz2008people, gendall2010effect}. They used participants' estimated true preferences based on actual voluntary donations as a reference to test the validity of contingent valuation methods on public or quasi-public goods. \textcite{xiao2019should} operationalized a voluntary donation with lottery-incentives in a MTurk setting. Second, voluntary donation, either online or offline, is an ecologically valid task that occurs in real-life settings. It does not require specialized knowledge and is simple to conduct online and at scale.} We now describe how our donation mechanism worked.
