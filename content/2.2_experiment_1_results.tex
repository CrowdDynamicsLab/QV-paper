...
\tc{Since we have two experiment conditions for each QV version (choosing two of the three versions with randomized order), we collected more QV participants than the Likert group. As Bayesian analysis is less sensitive to the sample size, we didn't see the sample size difference as an issue.}
