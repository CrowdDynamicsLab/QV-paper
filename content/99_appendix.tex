...
\tc{We present the experiment flow chart for experiment two in \Cref{fig:exp2_flow}. Specifically, \Cref{fig:exp2_store} provides the two interfaces involved in Step 6.
