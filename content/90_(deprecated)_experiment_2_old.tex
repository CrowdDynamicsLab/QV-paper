...
The second experiment extends upon the first one, and focus in an HCI setting. In other words, does the same result from Experiment one apply to another domain? Preference elicitation is a common theme in HCI studies. Different from political and public-opinion surveys, HCI surveys related to preference elicitation often focus on users' preferences on designs and user experiences. Understanding the preferences of users is an essential step in creating and improving designs to fit the users' needs. Preference elicitation in HCI surveys often impose immediate and tangible effects or feedback to the participants, a critical difference from the intangible outcomes generated from the political and public-opinion surveys. Therefore, a second experiment is needed to examine if QV offers the same benefit of better aligning with people's true preferences than Likert as shown in the donation task.
% made measuring participant's real preference much more non-trivial to measure compared to the donation task.
% Thus, we developed a buyback mechanism and observed participants' behaviors in that task.
This experiment also acts as a concrete example of how QV can be incorporated in an HCI study.
