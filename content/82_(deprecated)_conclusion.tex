...
% entirely as QV requires a computational engine and thus may be unsuitable for some surveys. 

% . Rather, we encourage decision-makers to consider QV as a promising alternative to the Likert scale in resource-constrained scenarios that require information about both ratings and rankings, and researchers to further explore the many open questions we proposed of QV in future work.