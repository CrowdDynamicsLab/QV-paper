...
% We begin our discussion by answering all three research questions.
...
% QV aligns much closer to participants' true preference and provides much more information when making a collective decision in a 1 in $K$ setting. Instead, we want to understand if an alternative voting mechanism can assist better collective decision-making. 
