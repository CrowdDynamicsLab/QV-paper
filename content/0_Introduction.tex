...
\textit{RQ1.} How does results from QV, Likert survey align with people's behavior when surveying societal issues? Unlike prior works, we designed an experiment that collects the participant's donation behaviors, comparing it with survey results of QV and Likert Surveys. We applied bayesian analysis and qualitative analysis to the results. We hypothesis that QV better reflects individuals' true beliefs. 
